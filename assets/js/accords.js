...
//
// Sur les fromages, la table suit le consensus des sommeliers plutôt que
// l'habitude : les tanins d'un rouge s'accrochent aux protéines du lait et
// durcissent en bouche, le sel du fromage amplifiant encore l'astringence,
...
const PAR_CEPAGE = {
  ...
  nebbiolo: profil('tannique et racé, arômes de rose et de goudron', '17-18 °C',
    { gibier: 3, viandeRouge: 3, fromageFort: 1, pates: 2 }),
  ...
  corvina: profil('fruits confits et épices, chaleureux', '17-18 °C',
    { viandeRouge: 3, gibier: 3, fromageFort: 2, pates: 2 }),
  ...
  primitivo: profil('puissant et confituré, léger sucré', '16-18 °C',
    { viandeRouge: 3, gibier: 2, fromageFort: 1, epice: 3, pizza: 2 }),
  ...
  'cabernet sauvignon': profil('structuré, cassis et cèdre', '17-18 °C',
    { viandeRouge: 3, gibier: 3, fromageFort: 1 }),
  ...
  syrah: profil('poivre noir et violette, dense', '16-18 °C',
    { viandeRouge: 3, gibier: 3, epice: 2, charcuterie: 2, fromageFort: 1 }),
  ...
  tempranillo: profil('cuir et fruits mûrs, élevage boisé', '16-18 °C',
    { viandeRouge: 3, charcuterie: 3, fromageFort: 1, gibier: 2 }),
  'humagne rouge': profil('rustique et sauvage, note ferreuse', '16-17 °C',
    { gibier: 3, viandeRouge: 2, fromageFort: 1, charcuterie: 2 }),
  ...
  teran: profil('acidulé et minéral, typé istrien', '15-17 °C',
    { charcuterie: 3, viandeRouge: 2, pates: 2, fromageFort: 1 }),
  ...
  'sauvignon blanc': profil('vif, agrumes et buis', '8-10 °C',
    { aperitif: 3, fruitsDeMer: 3, poisson: 3,
      vegetarien: 3, fromageDoux: 3, patesFruitsDeMer: 3 }),
  pecorino: profil('sapide et salin, belle tension', '10-12 °C',
    { poisson: 3, fruitsDeMer: 3, pates: 2, vegetarien: 2,
      aperitif: 2, patesFruitsDeMer: 3, fromageDoux: 2 }),
  grillo: profil('sec et méditerranéen, amande', '9-11 °C',
    { poisson: 3, fruitsDeMer: 2, epice: 3, volaille: 2,
      vegetarien: 2, patesFruitsDeMer: 3, fromageDoux: 2 }),
  greco: profil('corsé pour un blanc, fruits jaunes', '10-12 °C',
    { poisson: 3, fruitsDeMer: 2, volaille: 2, pates: 2, patesFruitsDeMer: 3, fromageDoux: 2 }),
  arneis: profil('floral et poire, rondeur', '10-12 °C',
    { aperitif: 3, poisson: 2, volaille: 2, vegetarien: 2, patesFruitsDeMer: 2, fromageDoux: 2 }),
  'pinot gris': profil('riche et épicé, parfois demi-sec', '10-12 °C',
    { epice: 3, volaille: 2, fromageFort: 3, dessert: 2,
      aperitif: 2, patesFruitsDeMer: 2, fromageDoux: 2 }),
  ...
  viognier: profil('abricot et fleurs blanches, onctueux', '10-12 °C',
    { epice: 3, volaille: 2, poisson: 2, dessert: 1, patesFruitsDeMer: 1, fromageDoux: 2 }),
  malvasia: profil('aromatique et souple', '9-11 °C',
    { aperitif: 3, vegetarien: 2, poisson: 2, dessert: 1, patesFruitsDeMer: 2, fromageDoux: 2 }),
  'ribolla gialla': profil('tendu et minéral', '9-11 °C',
    { aperitif: 2, fruitsDeMer: 3, poisson: 3,
      vegetarien: 2, patesFruitsDeMer: 3, fromageDoux: 2 }),
  moscato: profil('muscaté et doux, légèrement pétillant', '7-9 °C',
    { dessert: 3, aperitif: 2, epice: 2, fromageFort: 2 }),
  muscat: profil('raisin frais et fleurs, demi-sec à doux', '8-10 °C',
    { dessert: 3, aperitif: 2, epice: 2, fromageFort: 2 }),
  glera: profil('bulles fines, poire et fleurs', '6-8 °C',
    { aperitif: 3, fruitsDeMer: 2, poisson: 2, dessert: 1, patesFruitsDeMer: 2, fromageDoux: 3 }),
};
...
const PAR_APPELLATION = {
  amarone: profil('concentré et chaleureux, raisins passerillés', '17-18 °C',
    { gibier: 3, viandeRouge: 3, fromageFort: 2 }),
  ripasso: profil('charnu et épicé, entre deux mondes', '17-18 °C',
    { viandeRouge: 3, pates: 3, fromageFort: 1, gibier: 2 }),
  ...
  barolo: profil('tannique et racé, garde longue', '17-18 °C',
    { gibier: 3, viandeRouge: 3, fromageFort: 1 }),
  ...
  champagne: profil('bulles fines et tension', '8-10 °C',
    { aperitif: 3, fruitsDeMer: 3, poisson: 2, dessert: 1,
      patesFruitsDeMer: 3, fromageDoux: 3, fromageFort: 2 }),
  prosecco: profil('bulles légères et fruitées', '6-8 °C',
    { aperitif: 3, fruitsDeMer: 2, pizza: 2, patesFruitsDeMer: 2, fromageDoux: 3 }),
  ...
  vaud: profil('vin de Lavaux, léger et salin', '9-11 °C',
    { aperitif: 3, raclette: 3, poisson: 2, fromageDoux: 3, patesFruitsDeMer: 2 }),
};
...
const PAR_COULEUR = {
  ...
  rouge: profil('rouge de la cave', '16-18 °C',
    { viandeRouge: 2, pates: 2, charcuterie: 2, fromageFort: 1 }),
  blanc: profil('blanc de la cave', '9-12 °C',
    { poisson: 2, aperitif: 2, fruitsDeMer: 2, volaille: 2,
      patesFruitsDeMer: 3, fromageDoux: 3, fromageFort: 2 }),
  rose: profil('rosé, à servir bien frais', '10-12 °C',
    { aperitif: 3, charcuterie: 2, vegetarien: 2, pizza: 2,
